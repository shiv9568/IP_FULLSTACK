            ...
            <div className="max-w-5xl md:w-[900px] rounded-xl shadow-lg overflow-hidden">
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="w-full lg:w-1/2 p-6">
                        ...
                        <div className="mt-6">
                            <button className="bg-gradient-to-r from-blue-500 to-blue-600 text-white text-lg font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl hover:from-blue-600 hover:to-blue-700 transition duration-300">
